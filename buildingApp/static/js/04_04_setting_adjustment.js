...
function add(bid, p)
{
	...
	html += '<td style="vertical-align:middle"><input id="'+temp_spid+'_d" type="text" style="text-align:center; font-size:0.9em" class="form-control input-sm margin0" value="'+rate+'%" disabled /></td>';
	html += '<td style="vertical-align:middle">';
	html += '<button type="button" class="btn btn-xs btn-primary btn-block" onclick="change_start('+"'"+temp_spid+"', '"+bid+"'"+', $(this));">수정</button>';
	html += '<button type="button" class="btn btn-xs btn-success btn-block" style="display:none" onclick="change_end('+"'"+temp_spid+"', '"+bid+"'"+', $(this));">완료</button>';
	html += '</td>';
	html += '<td style="vertical-align:middle"><button type="button" class="btn btn-xs btn-primary btn-block" onclick="del('+"'"+temp_spid+"'"+', $(this));">삭제</button></td>';
